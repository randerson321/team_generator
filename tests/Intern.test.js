...
test("can add name for Intern", () => {
    const newHire = new Intern('Rashad', 25, 'rashad.anderson321@gmail.com');
...
test("can check email for Intern", () => {
    ...
    const newHire = new Intern('Rashad', 25, emailTest);
...
test("can check for Intern's github'", () => {
    const newHire = new Intern('Rashad', 25, 'rashad.anderson321@gmail.com', 'UCF');
