...
test("can add name for Manager", () => {
    const newHire = new Manager('Rashad', 25, 'rashad.anderson321@gmail.com');
...
test("can check email for Manager", () => {
    ...
    const newHire = new Manager('Rashad', 25, emailTest);
...
test("can check for Manager's office number'", () => {
    const newHire = new Manager('Rashad', 25, 'rashad.anderson321@gmail.com', 1997);
