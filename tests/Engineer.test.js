...
test("can add name for engineer", () => {
    const newHire = new Engineer('Rashad', 25, 'rashad.anderson321@gmail.com');
...
test("can check email for engineer", () => {
    const emailTest = 'rashad.anderson321@gmail.com';
    const newHire = new Engineer('Rashad', 25, emailTest);
...
test("can check for engineer's github'", () => {
    const newHire = new Engineer('Rashad', 25, 'rashad.anderson321@gmail.com', 'randerson321');
